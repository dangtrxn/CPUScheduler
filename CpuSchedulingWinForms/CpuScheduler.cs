...
namespace CpuSchedulingWinForms
{
    public partial class CpuScheduler : Form
    {
        ...
        private void buttonSRTF_Click(object sender, EventArgs e)
        {
            string userInput = Microsoft.VisualBasic.Interaction.InputBox("Enter number of processes:", "Number of Processes", "", -1, -1);
            Algorithms.srtfAlgorithm(userInput);
        }

        private void buttonMLFQ_Click(object sender, EventArgs e)
        {
            string userInput = Microsoft.VisualBasic.Interaction.InputBox("Enter number of processes:", "Number of Processes", "", -1, -1);
